...
import { Map, X, PanelLeftClose, PanelLeftOpen, PanelRightClose, PanelRightOpen, Ticket, PackageCheck, Wallet, FolderOpen, Users, Train, MessageCircle } from 'lucide-react'
...
export default function TripPlannerPage(): React.ReactElement | null {
  ...
  const TRIP_TABS = [
    ...
    ...(enabledAddons.collab && collabFeatures.chat ? [{ id: 'chat', label: t('collab.tabs.chat') || 'Chat', icon: MessageCircle }] : []),
    ...(enabledAddons.collab && (collabFeatures.notes || collabFeatures.polls || collabFeatures.whatsnext) ? [{ id: 'collab', label: t('admin.addons.catalog.collab.name'), icon: Users }] : []),
  ]
